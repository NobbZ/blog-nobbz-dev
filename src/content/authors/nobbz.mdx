...
After about one and a half year, he found a place where he wasn't only able to
build elixir applications, but also to have some impact at the environment, as
his new employer had a mission to give used bicycles a second home. Here he uses
Elixir "fullstack" through LiveView for an inhouse application.

In 2024, he gave a talk at CodeBEAM EU titled "[Reproducible deployments on the
BEAM with nix][talk-1]", where he shared his experiences and insights on using nix to
achieve reliable and consistent deployments for BEAM-based applications.

[talk-1]: https://youtu.be/HbtbdLolHeM?si=_6y70Wpl39Z593rl
